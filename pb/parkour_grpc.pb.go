...
// UnimplementedParkourServer must be embedded to have
...
func (UnimplementedParkourServer) testEmbeddedByValue()                 {}
...
func RegisterParkourServer(s grpc.ServiceRegistrar, srv ParkourServer) {
	// If the following call pancis, it indicates UnimplementedParkourServer was
